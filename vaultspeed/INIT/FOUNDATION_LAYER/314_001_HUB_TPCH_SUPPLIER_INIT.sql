CREATE OR REPLACE PROCEDURE "SF_SAMPLE_PROC"."HUB_TPCH_SUPPLIER_INIT"()
 RETURNS varchar 
LANGUAGE JAVASCRIPT 
...
var HUB_TGT_DEL = snowflake.createStatement( {sqlText: `
	DELETE  FROM "TPCH_DV_FL"."HUB_SUPPLIER" "HUB_TGT"
	WHERE  "HUB_TGT"."SRC_BK" IN(  'TPCH' )
