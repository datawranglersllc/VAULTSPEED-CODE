...
DROP VIEW IF EXISTS "TPCH_DV_BV"."HUB_SUPPLIER";
CREATE  VIEW "TPCH_DV_BV"."HUB_SUPPLIER"  AS 
	SELECT 
		  "DVT_SRC"."SUPPLIER_HKEY" AS "SUPPLIER_HKEY"
		, "DVT_SRC"."LOAD_DATE" AS "LOAD_DATE"
		, "DVT_SRC"."LOAD_CYCLE_ID" AS "LOAD_CYCLE_ID"
		, "DVT_SRC"."S_SUPPKEY_BK" AS "S_SUPPKEY_BK"
		, "DVT_SRC"."SRC_BK" AS "SRC_BK"
	FROM "TPCH_DV_FL"."HUB_SUPPLIER" "DVT_SRC"
	;
