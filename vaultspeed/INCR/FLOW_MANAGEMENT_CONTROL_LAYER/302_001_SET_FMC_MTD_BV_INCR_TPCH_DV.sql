CREATE OR REPLACE PROCEDURE "SF_SAMPLE_PROC"."SET_FMC_MTD_BV_INCR_TPCH_DV"(P_DAG_NAME VARCHAR2,
...
var HIST_INS = snowflake.createStatement( {sqlText: `
	...
	( 
		...
		WHERE  "FMCH_SRC"."SRC_BK" = 'TPCH_DV' AND "FMCH_SRC"."SUCCESS_FLAG" = 1
	)
	, "SRC_WINDOW" AS 
	( 
		SELECT 
		...
		WHERE  "FMCH_SRC"."SRC_BK" IN('TPCH') AND "FMCH_SRC"."SUCCESS_FLAG" = 1 AND "FMCH_SRC"."LOAD_CYCLE_ID" > "PREV_BV_LOAD"."LOAD_CYCLE_ID"
	)
	SELECT 
